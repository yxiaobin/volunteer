...
<div class="wrap-container clearfix">
    <form class="layui-form column-content-detail"  action="{{url("/editactivity")}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="layui-tab">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" required lay-verify="required" placeholder="请输入志愿项目的名称" autocomplete="off" class="layui-input" value="{{$obj->title}}">
                ...
                <div class="layui-form-item" id="yulan" style="height: 100px;width:80px;" >
                    <label class="layui-form-label">预览：</label>
                    <div class="layui-input-block">
                        <div class="layui-inline">
                            <img class="layui-upload-img" id="img" src="{{url("getImage/$obj->img")}}" width="120px" height="80px">
                ...
                <div class="layui-form-item" >
                    ...
                    <div class="layui-input-block">
                        <div class="layui-input-inline">
                            <input class="layui-input" name="start_time" placeholder="开始日" id="LAY_demorange_s" value="{{$obj->starttime}}">
                        </div>
                        <div class="layui-input-inline">
                            <input class="layui-input" name="end_time" placeholder="截止日" id="LAY_demorange_e" value="{{$obj->endtime}}">
                        </div>
                    </div>
                </div>
...
<div class="layui-form-item" style="padding-left: 10px;">
    <div class="layui-input-block">
        ...
        <button  type="button" class="layui-btn layui-btn-primary"><a href="javascript:history.go(-1)">返回</a></button>
    </div>
</div>
</form>
</div>
...
<script type="text/javascript">
    ...
    ue.ready(function() {
        //设置编辑器的内容
        ue.execCommand("inserthtml",'{!! $obj->content !!}') ;
    });
</script>
