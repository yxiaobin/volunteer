                ...
                <div class="layui-tab-item layui-show">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input id="name" name="name" type="text"  required lay-verify="required" placeholder="请输入类别的名称" autocomplete="off" class="layui-input" value="{{$category->name}}">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input id="introduction" type="text" name="introduction"  required lay-verify="required" placeholder="请输入该类别的简介" autocomplete="off" class="layui-input" value="{{$category->introduction}}">
    ...
    layui.use('layer',function () {
        ...
        $("#add").bind("click",function () {
            ...
            if(name=="" || introduction==""){
                ...
                $.ajax({
                    method:"post",
                    url:"/volunteer/public/editcategory",
                    data:{
                        id:"{{$category->id}}",
                        name:name,
